...
xhr.open("PUT", "https://rd1ru6sycc.execute-api.ap-south-1.amazonaws.com/items");
xhr.setRequestHeader("Content-Type", "application/json; charset=UTF-8");
xhr.setRequestHeader("Access-Control-Allow-Origin","http://moryeshomestay.com.s3-website.ap-south-1.amazonaws.com");
...
const body = JSON.stringify({
    ...
    "user_id": makeid(5),
    "coming_from": "test_town",
    "number_of_person": value.people,
    "last_name": value.email,
    "first_name": value.first_name,
    "phone_number": value.phone,
    "id_type": "test_id",
    "stay_duration": value.time
